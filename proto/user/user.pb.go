...
const (
	...
	UserRole_ROLE_USER    UserRole = 1 // customer — can book tables, view own orders
	UserRole_ROLE_MANAGER UserRole = 2 // handles walk-in orders, updates order status
	UserRole_ROLE_CHEF    UserRole = 3 // views order items, marks items as ready
	UserRole_ROLE_WAITER  UserRole = 4 // serves food, notified when items are ready
	UserRole_ROLE_ADMIN   UserRole = 5 // full access: dashboard, menu, users, orders, tables
)
...
type CreateUserRequest struct {
	...
	Roles         []UserRole             `protobuf:"varint,6,rep,packed,name=roles,proto3,enum=user.UserRole" json:"roles,omitempty"` // defaults to [ROLE_USER] if empty
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListUsersRequest struct {
	...
	Status        UserStatus             `protobuf:"varint,3,opt,name=status,proto3,enum=user.UserStatus" json:"status,omitempty"` // optional filter
	Role          UserRole               `protobuf:"varint,4,opt,name=role,proto3,enum=user.UserRole" json:"role,omitempty"`       // optional filter
	Keyword       string                 `protobuf:"bytes,5,opt,name=keyword,proto3" json:"keyword,omitempty"`                     // search in email / username / full_name
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AssignRoleRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	Roles         []UserRole             `protobuf:"varint,2,rep,packed,name=roles,proto3,enum=user.UserRole" json:"roles,omitempty"` // replaces existing roles entirely
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type VerifyCredentialsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // plain text
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *VerifyCredentialsResponse) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *VerifyCredentialsResponse) GetRoles() []UserRole {
	if x != nil {
		return x.Roles
	}
	return nil
...
const file_proto_user_user_proto_rawDesc = "" +
	"\n" +
	"\x15proto/user/user.proto\x12\x04user\x1a\x1fgoogle/protobuf/timestamp.proto\"\xca\x02\n" +
	"\x04User\x12\x17\n" +
	...
	"\x04role\x18\x04 \x01(\x0e2\x0e.user.UserRoleR\x04role\x12\x18\n" +
	"\akeyword\x18\x05 \x01(\tR\akeyword\"\xb0\x01\n" +
	...
	"\x19VerifyCredentialsResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\tR\x06userId\x12\x14\n" +
	"\x05email\x18\x04 \x01(\tR\x05email\x12$\n" +
	"\x05roles\x18\x05 \x03(\x0e2\x0e.user.UserRoleR\x05roles\"v\n" +
	...
	"\tROLE_CHEF\x10\x03\x12\x0f\n" +
	"\vROLE_WAITER\x10\x04\x12\x0e\n" +
	"\n" +
	"ROLE_ADMIN\x10\x05*^\n" +
	"\n" +
	"UserStatus\x12\x12\n" +
	...
	"\x10STATUS_SUSPENDED\x10\x032\xb7\x05\n" +
	"\vUserService\x12?\n" +
	"\n" +
	...
	"\fGetUserRoles\x12\x19.user.GetUserRolesRequest\x1a\x1a.user.GetUserRolesResponse\x12K\n" +
	"\x0eChangePassword\x12\x1b.user.ChangePasswordRequest\x1a\x1c.user.ChangePasswordResponse\x12T\n" +
	"\x11VerifyCredentials\x12\x1e.user.VerifyCredentialsRequest\x1a\x1f.user.VerifyCredentialsResponseB\"Z restaurant-management/proto/userb\x06proto3"
...
var file_proto_user_user_proto_goTypes = []any{
	...
	(*GetUserRolesRequest)(nil),       // 16: user.GetUserRolesRequest
	(*GetUserRolesResponse)(nil),      // 17: user.GetUserRolesResponse
	(*VerifyCredentialsRequest)(nil),  // 18: user.VerifyCredentialsRequest
	(*VerifyCredentialsResponse)(nil), // 19: user.VerifyCredentialsResponse
...
var file_proto_user_user_proto_depIdxs = []int32{
	...
	22, // 2: user.User.created_at:type_name -> google.protobuf.Timestamp
	22, // 3: user.User.updated_at:type_name -> google.protobuf.Timestamp
	...
	0,  // 14: user.VerifyCredentialsResponse.roles:type_name -> user.UserRole
	3,  // 15: user.UserService.CreateUser:input_type -> user.CreateUserRequest
	5,  // 16: user.UserService.GetUser:input_type -> user.GetUserRequest
	7,  // 17: user.UserService.GetUserByEmail:input_type -> user.GetUserByEmailRequest
	...
	12, // 20: user.UserService.ListUsers:input_type -> user.ListUsersRequest
	14, // 21: user.UserService.AssignRole:input_type -> user.AssignRoleRequest
	16, // 22: user.UserService.GetUserRoles:input_type -> user.GetUserRolesRequest
	20, // 23: user.UserService.ChangePassword:input_type -> user.ChangePasswordRequest
	18, // 24: user.UserService.VerifyCredentials:input_type -> user.VerifyCredentialsRequest
	4,  // 25: user.UserService.CreateUser:output_type -> user.CreateUserResponse
	6,  // 26: user.UserService.GetUser:output_type -> user.GetUserResponse
	6,  // 27: user.UserService.GetUserByEmail:output_type -> user.GetUserResponse
	...
	13, // 30: user.UserService.ListUsers:output_type -> user.ListUsersResponse
	15, // 31: user.UserService.AssignRole:output_type -> user.AssignRoleResponse
	17, // 32: user.UserService.GetUserRoles:output_type -> user.GetUserRolesResponse
	21, // 33: user.UserService.ChangePassword:output_type -> user.ChangePasswordResponse
	19, // 34: user.UserService.VerifyCredentials:output_type -> user.VerifyCredentialsResponse
