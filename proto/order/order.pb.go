...
func (x *CreateOrderRequest) GetTable() string {
	if x != nil {
		return x.Table
	}
	return ""
...
const file_order_order_proto_rawDesc = "" +
	"\n" +
	"\x11order/order.proto\x12\x05order\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa3\x01\n" +
	"\tOrderItem\x12\x17\n" +
	...
	"\bquantity\x18\x06 \x01(\x05R\bquantity\"\xfc\x01\n" +
	"\x05Order\x12\x19\n" +
	...
	"totalPrice\x12&\n" +
	"\x05items\x18\b \x03(\v2\x10.order.OrderItemR\x05items\"q\n" +
	"\x10OrderItemRequest\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\tR\x06itemId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05price\x18\x03 \x01(\x01R\x05price\x12\x1a\n" +
	"\bquantity\x18\x04 \x01(\x05R\bquantity\"\xe2\x01\n" +
	...
	"\x05items\x18\b \x03(\v2\x17.order.OrderItemRequestR\x05items\"m\n" +
	...
	"\akeyword\x18\x04 \x01(\tR\akeyword\"\xb5\x01\n" +
	...
	"\x05order\x18\x01 \x01(\v2\f.order.OrderR\x05order\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage2\x99\x05\n" +
	"\fOrderService\x12D\n" +
	...
	"\x0fRemoveOrderItem\x12\x1d.order.RemoveOrderItemRequest\x1a\x1e.order.RemoveOrderItemResponseB#Z!restaurant-management/proto/orderb\x06proto3"
...
var file_order_order_proto_depIdxs = []int32{
	21, // 0: order.Order.time:type_name -> google.protobuf.Timestamp
	0,  // 1: order.Order.items:type_name -> order.OrderItem
	2,  // 2: order.CreateOrderRequest.items:type_name -> order.OrderItemRequest
	1,  // 3: order.CreateOrderResponse.order:type_name -> order.Order
	1,  // 4: order.GetOrderResponse.order:type_name -> order.Order
	2,  // 5: order.UpdateOrderRequest.items:type_name -> order.OrderItemRequest
	...
	2,  // 9: order.AddOrderItemRequest.item:type_name -> order.OrderItemRequest
	1,  // 10: order.AddOrderItemResponse.order:type_name -> order.Order
	1,  // 11: order.RemoveOrderItemResponse.order:type_name -> order.Order
	...
	7,  // 14: order.OrderService.UpdateOrder:input_type -> order.UpdateOrderRequest
	9,  // 15: order.OrderService.DeleteOrder:input_type -> order.DeleteOrderRequest
	11, // 16: order.OrderService.CancelOrder:input_type -> order.CancelOrderRequest
	...
	17, // 19: order.OrderService.AddOrderItem:input_type -> order.AddOrderItemRequest
	19, // 20: order.OrderService.RemoveOrderItem:input_type -> order.RemoveOrderItemRequest
	4,  // 21: order.OrderService.CreateOrder:output_type -> order.CreateOrderResponse
	6,  // 22: order.OrderService.GetOrder:output_type -> order.GetOrderResponse
	8,  // 23: order.OrderService.UpdateOrder:output_type -> order.UpdateOrderResponse
	10, // 24: order.OrderService.DeleteOrder:output_type -> order.DeleteOrderResponse
	12, // 25: order.OrderService.CancelOrder:output_type -> order.CancelOrderResponse
	14, // 26: order.OrderService.ListOrders:output_type -> order.ListOrdersResponse
	16, // 27: order.OrderService.UpdateOrderStatus:output_type -> order.UpdateOrderStatusResponse
	18, // 28: order.OrderService.AddOrderItem:output_type -> order.AddOrderItemResponse
	20, // 29: order.OrderService.RemoveOrderItem:output_type -> order.RemoveOrderItemResponse
